...
from src.modelYiGou import HGDDI
...
def ConstructGraph(drug_structure, drug_target, drug_enzyme, drug_path, drug_drug):
    ...
    g1_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('structure', 'structure_structure virtual', 'structure'): list_structure,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_structure interaction', 'structure'): list_drug_structure, \
                             ('structure', 'structure_drug interaction', 'drug'): list_structure_drug, \
                              })
    g1 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_structure interaction',
                                  'structure_drug interaction'])

    g2_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('target', 'target_target virtual', 'target'): list_target,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_target association', 'target'): list_drug_target, \
                             ('target', 'target_drug association', 'drug'): list_target_drug, \
                                })
    g2 = g_HIN.edge_type_subgraph(['drug_drug interaction',  'drug_target association',
                                  'target_drug association'])


    g3_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_enzyme association', 'enzyme'): list_drug_enzyme, \
                             ('enzyme', 'enzyme_drug association', 'drug'): list_enzyme_drug, \
                              })
    g3 = g_HIN.edge_type_subgraph(['drug_drug interaction','drug_enzyme association',
                                  'enzyme_drug association'
                                  ])
    g4_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('path', 'path_path virtual', 'path'): list_path,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_path association', 'path'): list_drug_path, \
                             ('path', 'path_drug association', 'drug'): list_path_drug})
    g4 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_path association',
                                  'path_drug association'])

    g5_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('structure', 'structure_structure virtual', 'structure'): list_structure,
                             ('target', 'target_target virtual', 'target'): list_target,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_structure interaction', 'structure'): list_drug_structure, \
    ...
    g5 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_structure interaction',
                                  'structure_drug interaction', 'drug_target association',
                                  'target_drug association'])
    g6_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('structure', 'structure_structure virtual', 'structure'): list_structure,
                             ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_structure interaction', 'structure'): list_drug_structure, \
    ...
    g6 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_structure interaction',
                                  'structure_drug interaction',  'drug_enzyme association',
                                  'enzyme_drug association'])

    g7_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('structure', 'structure_structure virtual', 'structure'): list_structure,
                             ('path', 'path_path virtual', 'path'): list_path,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_structure interaction', 'structure'): list_drug_structure, \
                             ...
                             ('drug', 'drug_path association', 'path'): list_drug_path, \
                             ('path', 'path_drug association', 'drug'): list_path_drug})
    g7 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_structure interaction',
                                  'structure_drug interaction','drug_path association',
                                  'path_drug association'])
    g8_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                              ('structure', 'structure_structure virtual', 'structure'): list_structure,
                              ('target', 'target_target virtual', 'target'): list_target,
                              ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                              ('path', 'path_path virtual', 'path'): list_path,
                             ...
                             ('drug', 'drug_enzyme association', 'enzyme'): list_drug_enzyme, \
                             ('enzyme', 'enzyme_drug association', 'drug'): list_enzyme_drug})
    g8 = g_HIN.edge_type_subgraph(['drug_drug interaction',  'drug_target association',
                                  'target_drug association', 'drug_enzyme association',
                                  'enzyme_drug association'])
    g9_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('target', 'target_target virtual', 'target'): list_target,
                             ('path', 'path_path virtual', 'path'): list_path,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_target association', 'target'): list_drug_target, \
                             ...
                             ('drug', 'drug_path association', 'path'): list_drug_path, \
                             ('path', 'path_drug association', 'drug'): list_path_drug})
    g9 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_target association',
                                  'target_drug association','drug_path association',
                                  'path_drug association'])
    g10_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                             ('path', 'path_path virtual', 'path'): list_path,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ('drug', 'drug_enzyme association', 'enzyme'): list_drug_enzyme, \
                             ...
                             ('drug', 'drug_path association', 'path'): list_drug_path, \
                             ('path', 'path_drug association', 'drug'): list_path_drug})
    g10 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_enzyme association',
                                  'enzyme_drug association', 'drug_path association',
                                  'path_drug association'])
    g11_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('structure', 'structure_structure virtual', 'structure'): list_structure,
                             ('target', 'target_target virtual', 'target'): list_target,
                             ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ...
                             ('drug', 'drug_enzyme association', 'enzyme'): list_drug_enzyme, \
                             ('enzyme', 'enzyme_drug association', 'drug'): list_enzyme_drug})
    g11 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_structure interaction',
                                  'structure_drug interaction', 'drug_target association',
                                  'target_drug association', 'drug_enzyme association',
                                  'enzyme_drug association'])
    g12_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('structure', 'structure_structure virtual', 'structure'): list_structure,
                             ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                             ('path', 'path_path virtual', 'path'): list_path,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ...
                             ('drug', 'drug_path association', 'path'): list_drug_path, \
                             ('path', 'path_drug association', 'drug'): list_path_drug})
    g12 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_structure interaction',
                                  'structure_drug interaction','drug_enzyme association',
                                  'enzyme_drug association', 'drug_path association',
                                  'path_drug association'])
    g13_HIN = dgl.heterograph({('drug', 'drug_drug virtual', 'drug'): list_drug,
                             ('target', 'target_target virtual', 'target'): list_target,
                             ('enzyme', 'enzyme_enzyme virtual', 'enzyme'): list_enzyme,
                             ('path', 'path_path virtual', 'path'): list_path,
                             ('drug', 'drug_drug interaction', 'drug'): list_drug_drug, \
                             ...
                             ('drug', 'drug_path association', 'path'): list_drug_path, \
                             ('path', 'path_drug association', 'drug'): list_path_drug})
    g13 = g_HIN.edge_type_subgraph(['drug_drug interaction', 'drug_target association',
                                  'target_drug association', 'drug_enzyme association',
                                  'enzyme_drug association', 'drug_path association',
                                  'path_drug association'
                                  ])
...
def TrainAndEvaluate(DDItrain, DDIvalid, DDItest, args, drug_structure, drug_target, drug_enzyme, drug_path, drug_drug):
    ...
    modelYiGou = HGDDI(g, num_drug,num_structure,num_target,num_enzyme,num_path, args)
    modelYiGou.to(device)

    optimizer = th.optim.Adam(modelYiGou.parameters(), lr=args.lr, weight_decay=args.weight_decay)

    for i in range(args.epochs):#共执行args.epoch次循环

        modelYiGou.train()
        tloss, ddiloss, l2loss, dd_re, DDI_p = modelYiGou(drug_structure, drug_target, drug_enzyme, drug_path,drug_drug,mask)
        #返回的是总损失=ddloss+other_loss+L2_loss，dd的重构损失，L2损失，潜在的DDI
        results = dd_re.detach().cpu()
        optimizer.zero_grad()
        loss = tloss
        loss.backward()
        th.nn.utils.clip_grad_norm_(modelYiGou.parameters(), 1)
        optimizer.step()
    ...
    return test_auc, test_aupr, xy_roc_sampling, xy_pr_sampling, best_DDI_potential,precision,recall,f1,accuracy,db , y_pred, y_true,ground_truth, pred_list
...
if __name__ == "__main__":
    ...
    for r in range(rounds):
        ...
        for train_index, test_index in kf.split(data_set[:, :2], data_set[:, 2]):
            ...
            t_auc, t_aupr, xy_roc, xy_pr, DDI_potential, precision, recall, f1, accuracy, db, y_pred, y_true,ground_truth, pred_list= TrainAndEvaluate(
            ...
            print("########################################################################")
            print(t_auc, t_aupr, precision, recall, f1, accuracy)
            print("########################################################################")
